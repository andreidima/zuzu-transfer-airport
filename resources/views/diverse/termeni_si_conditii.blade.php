                ...
                <div class="col-lg-12 px-0" style="border:15px #2C7996 solid; ">
                        ...
                        <div class="p-2 mb-4">
                            ...
                            <ol>
                                ...
                                <li>Biletele de calatorie se pot plati astfel:
                                    ...
                                    <li>In momentul rezervarii biletului pe site-ul <a href="https://rezervari.zuzulicatrans.ro/">ZUZULICA TRANS SRL</a>, prin plata cu cardul. Procesul este securizat și se realizează prin intermediul procesatorului de plăți Netopia Mobilpay  <img src="{{ asset('images/netopia_banner_blue.jpg') }}" class="border border-2 border-black" width="350px"> , <span style="font-size: 16px;">fiind similar cu orice plată din site-urile de comerț electronic.</span></li>
                                    </ul>
                                </li>
                                ...
                                <li>Eventualele sesizari ale calatorilor privind desfasurarea transportului, sub toate aspectele, se transmit direct către Iulian Lemnaru prin email <a href="mailto:rezervari@zuzulicatrans.ro">rezervari@zuzulicatrans.ro</a> sau la telefon <a href="tel:+40768112244"> +40 768 112 244</a>, in termen de 3 zile de la data incheierii calatoriei. Reclamatiile transmise dupa acest termen nu se iau in considerare.</li>
                    ...
                    <h1 class="text-white text-center py-1 pt-4" style="background-color:#2C7996;">TERMENI SI CONDITII DE UTILIZARE A SITEULUI</h1>
                        <div class="p-2 mb-4">
                            ...
                            <p>SITE: reprezintă SITE-ul Internet aparținând ZUZULICA TRANS SRL, care se află la adresa https://zuzulicatrans.ro/, prin intermediul căruia UTILIZATORUL are acces la informații privind serviciile și produsele oferite / asigurate de către ZUZULICA TRANS SRL.</p>
