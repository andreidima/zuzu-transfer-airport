            ...
            <div class="row mb-3 bg-white">
                ...
                <div class="col-lg-12 px-0" style="border:15px #2C7996 solid; ">
                    <h1 class="text-white text-center py-1" style="background-color:#2C7996;">CONDIŢII GENERALE DE TRANSPORT PERSOANE</h1>
                        <div class="p-2 mb-4">
                            <p>ZUZULICA TRANS SRL, având sediul social in Str. Vrancei 20D C, Focșani, înregistrată la Registrul Comerțului sub nr. J39/603/2020, având CUI 43014220, oferă servicii de transport persoane în următoarele condiții:</p>
                            ...
                            <ol>
                                ...
                                <li>In autocar, in statiile de oprire, calatorul trebuie sa respecte indicatiile personalului angajat al transportatorului.</li>
