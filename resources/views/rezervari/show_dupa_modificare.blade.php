    ...
    <div class="container p-0" id="orase-ore-plecare">
        ...
        <div class="">
            <form  class="needs-validation" novalidate method="POST" action="{{ $rezervari->path() }}">
                ...
                <div class="form-row mb-0 d-flex justify-content-center">
                    <div class="form-group col-lg-6 card shadow-sm px-2 mb-0" style="background-color:#FFDF8E">
                        ...
                        <div class="form-row mb-2 d-flex justify-content-between">
                            ...
                            <div class="form-group col-lg-5 mb-0">
                                <label for="ora_sosire" class="gorm-label mb-0">Ora sosire:</label>
                                <input
                                    type="text"
                ...
                <div class="form-row mb-0 d-flex justify-content-center">
                    <div class="form-group col-lg-6 border card shadow-sm px-2 mb-0" style="background-color:#FFDF8E">
                        <div class="form-row mb-0 d-flex justify-content-between">
                            <div class="form-group col-lg-5 mb-0 ">
                            ...
                            <div class="form-group col-lg-12 mb-0 mt-1 d-flex border-bottom">
                                <label class="col-form-label">Plata:<span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-check mr-4 mt-1">
                                        ...
                                        disabled
                                        >
                                        <label class="form-label " for="tip_plata_id">La șofer</label>
                                    </div>
                                    <div class="form-check ml-4 mt-1">
                                        ...
                                        disabled
                                        >
                                        <label class="form-label " for="tip_plata_id">La agenție</label>
                                    </div>
                            </div>
                            {{-- <div class="form-group col-lg-12 mb-0 mt-1 d-flex border-bottom">
                                <script type="application/javascript">
